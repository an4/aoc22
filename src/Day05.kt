fun main() {
    fun part1(moves: List<String>, stacks: List<ArrayDeque<Char>>): String {
        for (move in moves) {
            val parts = move.split(" ")
            val quantity = parts[1].toInt()
            val sourceId = parts[3].toInt()
            val destinationId = parts[5].toInt()

            for (i in 1..quantity) {
                val box =  stacks[sourceId - 1].removeLast()
                stacks[destinationId - 1].addLast(box)
            }
        }
    ...
    fun part2(moves: List<String>, stacks: List<ArrayDeque<Char>>): String {
        for (move in moves) {
            val parts = move.split(" ")
            val quantity = parts[1].toInt()
            val sourceId = parts[3].toInt()
            ...
            val tempStack: ArrayDeque<Char> = ArrayDeque(listOf())
            for (i in 1..quantity) {
                tempStack.addFirst(stacks[sourceId - 1].removeLast())
            }
            stacks[destinationId - 1].addAll(tempStack)
        }
...
//    1   2   3   4   5   6   7   8   9
    ...
    val stacks: List<ArrayDeque<Char>> = arrayListOf(
        ...
        ArrayDeque(listOf('N', 'R', 'C'))
    )
    val stacks2: List<ArrayDeque<Char>> = arrayListOf(
        ArrayDeque(listOf('S', 'Z', 'P', 'D', 'L', 'B', 'F', 'C')),
        ArrayDeque(listOf('N', 'V', 'G', 'P', 'H', 'W', 'B')),
        ArrayDeque(listOf('F', 'W', 'B', 'J', 'G')),
        ArrayDeque(listOf('G', 'J', 'N', 'F', 'L', 'W', 'C', 'S')),
